...
class Embed(nn.Module):
    def __init__(self, dim_in=64, dim_out=64):
        super(Embed,self).__init__()
        self.conv = nn.Conv2d(dim_in, dim_out, kernel_size=1, stride=1, bias=False)
...
class FM_LOSS(nn.Module):
    ...
    def forward(self,f_s, f_t):
        s, q, v = f_s, f_s,f_s # student feature, query, value
        t, k = f_t, f_t # teacher feature, key
...
# fs = torch.randn(24, 512, 9)
# ft = torch.randn(24, 2048, 9)
# loss = FM_LOSS().cuda()
