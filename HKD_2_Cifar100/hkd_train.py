...
from model import resnet56,resnet32,Sum_weights
...
def train_once_data(num):
    ...
    load_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'HKD1_6.pkl')
    ...
    writer = SummaryWriter(comment='HKD_4')
    Loss = []
    Acc_rate =[]
